...
POINTS: dict[str, dict] = {
    ...
    # -- recorrido real de la unidad tipo dúplex (Bloque 2, unidad A)
    # El `sort` es el guion: el orden en que se recorre la unidad, de la
    # llegada al ultimo ambiente. No es el orden en que se fotografio.
    "B2-A_LLEGADA": dict(slug="p-b2a-llegada", name="La llegada",
                         hotspots=[], claims=[], yaw=0.0, fov=95, sort=30),
    "B2-A_GALERIA": dict(slug="p-b2a-galeria", name="La galería",
                         hotspots=[], claims=[], yaw=0.0, fov=90, sort=31),
    "B2-A_LIVING": dict(slug="p-b2a-living", name="El living",
                        hotspots=[], claims=[], yaw=0.0, fov=85, sort=32),
    "B2-A_COCINA": dict(slug="p-b2a-cocina", name="La cocina",
                        hotspots=[], claims=[], yaw=0.0, fov=85, sort=33),
    "B2-A_LIVING-ESCALERA": dict(slug="p-b2a-living-escalera", name="El living y la escalera",
                                 hotspots=[], claims=[], yaw=0.0, fov=85, sort=34),
    "B2-A_LIVING-TERRAZA": dict(slug="p-b2a-living-terraza", name="Hacia la terraza",
                                hotspots=[], claims=[], yaw=0.0, fov=85, sort=35),
    "B2-A_TERRAZA": dict(slug="p-b2a-terraza", name="La terraza",
                         hotspots=[], claims=[], yaw=0.0, fov=90, sort=36),
    "B2-A_ESCALERA": dict(slug="p-b2a-escalera", name="Bajando",
                          hotspots=[], claims=[], yaw=0.0, fov=85, sort=37),
    "B2-A_DORM-01": dict(slug="p-b2a-dorm-01", name="Dormitorio principal",
                         hotspots=[], claims=[], yaw=0.0, fov=85, sort=38),
    "B2-A_DORM-02": dict(slug="p-b2a-dorm-02", name="Segundo dormitorio",
                         hotspots=[], claims=[], yaw=0.0, fov=85, sort=39),
    "B2-A_DORM-03": dict(slug="p-b2a-dorm-03", name="El tercer ambiente",
                         hotspots=[], claims=[], yaw=0.0, fov=85, sort=40),
    "B2-A_VESTIDOR": dict(slug="p-b2a-vestidor", name="El vestidor",
                          hotspots=[], claims=[], yaw=0.0, fov=80, sort=41),
    "B2-A_BANO-01": dict(slug="p-b2a-bano-01", name="Baño principal",
                         hotspots=[], claims=[], yaw=0.0, fov=80, sort=42),
    "B2-A_BANO-02": dict(slug="p-b2a-bano-02", name="Baño",
                         hotspots=[], claims=[], yaw=0.0, fov=80, sort=43),
    "B2-A_BANO-03": dict(slug="p-b2a-bano-03", name="Toilette",
                         hotspots=[], claims=[], yaw=0.0, fov=80, sort=44),
