...
values
  ...
  ('a0000000-0000-0000-0003-000000000002', 'a0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0001-000000000002', 'a0000000-0000-0000-0002-000000000001', 'B2-B', 'reservado',     173.00, jsonb_build_object('dormitorios', 2, 'niveles', 2), 2),
  ('a0000000-0000-0000-0003-000000000003', 'a0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0001-000000000002', 'a0000000-0000-0000-0002-000000000001', 'B2-C', 'vendido',       173.00, jsonb_build_object('dormitorios', 2, 'niveles', 2), 3),
  ('a0000000-0000-0000-0003-000000000004', 'a0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0001-000000000002', 'a0000000-0000-0000-0002-000000000001', 'B2-D', 'bloqueado',     173.00, jsonb_build_object('dormitorios', 2, 'niveles', 2), 4),
  ('a0000000-0000-0000-0003-000000000005', 'a0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0001-000000000002', 'a0000000-0000-0000-0002-000000000001', 'B2-E', 'no_disponible', 173.00, jsonb_build_object('dormitorios', 2, 'niveles', 2), 5),
...
insert into units (id, project_id, group_id, unit_type_id, code, status, area_total_m2, attrs, sort)
values
  ('a0000000-0000-0000-0003-000000000010', 'a0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0001-000000000003', 'a0000000-0000-0000-0002-000000000001', 'B3-A', 'disponible',    175.92, jsonb_build_object('dormitorios', 2, 'niveles', 2), 1),
  ('a0000000-0000-0000-0003-000000000011', 'a0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0001-000000000003', 'a0000000-0000-0000-0002-000000000001', 'B3-B', 'vendido',       173.00, jsonb_build_object('dormitorios', 2, 'niveles', 2), 2),
  ('a0000000-0000-0000-0003-000000000012', 'a0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0001-000000000003', 'a0000000-0000-0000-0002-000000000001', 'B3-C', 'reservado',     173.00, jsonb_build_object('dormitorios', 2, 'niveles', 2), 3),
  ('a0000000-0000-0000-0003-000000000013', 'a0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0001-000000000003', 'a0000000-0000-0000-0002-000000000002', 'B3-D', 'disponible',    95.92,  jsonb_build_object('dormitorios', 1), 4),
  ('a0000000-0000-0000-0003-000000000014', 'a0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0001-000000000003', 'a0000000-0000-0000-0002-000000000002', 'B3-E', 'disponible',    106.90,  jsonb_build_object('dormitorios', 1), 5),
  ('a0000000-0000-0000-0003-000000000015', 'a0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0001-000000000003', 'a0000000-0000-0000-0002-000000000002', 'B3-F', 'bloqueado',     95.92,  jsonb_build_object('dormitorios', 1), 6),
  ('a0000000-0000-0000-0003-000000000016', 'a0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0001-000000000003', 'a0000000-0000-0000-0002-000000000002', 'B3-G', 'no_disponible', 89.94,  jsonb_build_object('dormitorios', 1), 7),
  ('a0000000-0000-0000-0003-000000000017', 'a0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0001-000000000003', 'a0000000-0000-0000-0002-000000000002', 'B3-H', 'disponible',    95.92,  jsonb_build_object('dormitorios', 1), 8),
  ('a0000000-0000-0000-0003-000000000018', 'a0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0001-000000000003', 'a0000000-0000-0000-0002-000000000002', 'B3-I', 'reservado',     89.94,  jsonb_build_object('dormitorios', 1), 9),
  ('a0000000-0000-0000-0003-000000000019', 'a0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0001-000000000003', 'a0000000-0000-0000-0002-000000000002', 'B3-J', 'vendido',       95.92,  jsonb_build_object('dormitorios', 1), 10),
  ('a0000000-0000-0000-0003-000000000020', 'a0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0001-000000000003', 'a0000000-0000-0000-0002-000000000002', 'B3-K', 'disponible',    106.90,  jsonb_build_object('dormitorios', 1), 11)
on conflict (id) do nothing;
